...
namespace NugetPackagerAssistant
{
    public class NugetPackager
    {
        ...
        private void PublishNupkgToSharedFolder()
        {
            ...
            if (GetUsersChoice(ConsoleKey.Y, ConsoleKey.N) == ConsoleKey.Y)
            {
        ...
        private void PackCsproj()
        {
            ...
            var process = StartNewProcess(_outputDirectory, arguments);
        ...
        private ConsoleKey GetUsersChoice(ConsoleKey firstPossibility, ConsoleKey secondPossility)
        {
        ...
        {
            _usersModeChoice = GetUsersChoice(ConsoleKey.A, ConsoleKey.B) == ConsoleKey.A
        ...
        private bool GenerateNuspec()
        {
            ...
            Process process = StartNewProcess(_tmpDirectoryPath);
        ...
        {
            Process process = StartNewProcess(_outputDirectory);
        ...
        private Process StartNewProcess(string workingDirectory, string arguments = null)
        {
